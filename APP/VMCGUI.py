...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fileNameText.textChanged.connect(self.resumeOrNot)
    ...
    def resumeOrNot(self):
        if os.path.exists(self.dir + self.fileNameText.text() + self.suffix):
            self.recButton.setIcon(QtGui.QIcon(":/RESUME.png"))
            self.recButton.setText(" RESUME")
        else:
            self.recButton.setIcon(QtGui.QIcon(":/REC.png"))
            self.recButton.setText(" REC")
...
class Dialog(QtWidgets.QMessageBox):
    ...
    def __init__(self, errorCode, *args, **kwargs):
        ...
        if self.errorCode == 0x00:
            ...
            self.setWindowTitle("Resume recording on this file ?")

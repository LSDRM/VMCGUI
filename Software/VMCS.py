    ...
    ################################################################################################
    ### VMCS - CEA/Laboratory Structure and Dynamics by Magnetic Resonance - Corentin COUTELLIER ###
    ################################################################################################
...
#         self.setWindowTitle("VMCS - Second Kit")
#         global deviceMem
...
class DataPlot(QtWidgets.QMainWindow):
    ...
    def __init__(self, ID, *args, **kwargs):        # , xName, x, yName, y, 
        ...
        self.setWindowTitle("VMCS - Data plot window - " + self.fileName[0])
...
class SetupWindow(QtWidgets.QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle("VMCS - choose your kit")
